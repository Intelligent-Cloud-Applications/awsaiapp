...
const Price = () => {
  ...
  return (
    <div className="w-full flex md:flex-row max1008:flex-col-reverse justify-center border-2 px-5 overflow-hidden py-[8rem] max375:py-[4rem]">
      <div className="home-faq flex flex-col items-start justify-start gap-10 md:py-32 lg:w-[60%] max-w-screen-xl mx-auto px-5 md:px-10 lg:px-16 xl:px-20">
        <div className="flex flex-col max-w-screen-sm">
          <div className="w-80 h-10 lg:w-80 lg:h-25 flex items-center justify-start">
            <div className="text-3xl md:text-5xl lg:text-9xl max375:text-2xl font-bold font-inter">
      ...
      <div className="flex flex-col justify-center lg:w-1/3 xl:w-1/3 mx-8 gap-6 lg:mr-20 max375:gap-4 max375:mx-4">
        <div className="flex flex-col gap-10 bg-white p-3 rounded-sm shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] max375:gap-6">
          <div className="flex flex-row justify-between text-xl md:text-2xl lg:text-3xl max375:text-lg font-semibold">
            <h3>Basic</h3>
            <h3>₹1,000</h3>
          </div>
          <div className="flex items-end justify-start">
            <button
              ...
              className="bg-[#30AFBC] hover:bg-slate-900 text-white py-1 px-3 rounded duration-300 hover:scale-105 shadow-lg max375:text-sm max375:py-0.5 max375:px-2"
            >
              Learn More
            </button>
          </div>
