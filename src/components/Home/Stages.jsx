...
const Stages = () => {
  ...
  return (
    <div className="h-[100vh] w-full bg-[#30AFBC]"
    onMouseEnter={() => {
    ...
    onMouseLeave={() => {
      ...
      <div className="w-full h-[85vh] px-52 py-20">
        <div className="relative flex flex-col justify-around items-center bg-white w-full h-full shadow-full rounded-lg p-2 overflow-hidden">
          ...
          <div className="flex justify-center items-center h-[15vh]">
            <button
              ...
              className="bg-[#30AFBC] text-white px-4 py-2 rounded-full font-semibold text-base md:text-xl lg:text-xl hover:bg-[#57C3CE]"
            >
