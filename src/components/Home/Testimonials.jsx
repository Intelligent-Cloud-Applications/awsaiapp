  ...
  return (
    <div className="testi flex flex-col w-full ">
      ...
      <div className="flex justify-center item-center py-[5rem] max500:py-[rem] mx-5">
        ...
        <div
          className="flex flex-col h-[55vh] max375:h-[65vh] bg-white justify-center item-center lg:w-[45%] max1300:min-w-[60%] sm:w-[60%] max670:w-[85%] 
        ...
        >
          <div className="flex h-[20%] justify-between items-end mb-[-1rem]">
            <img
              className="h-[1rem] sm:h-[1.2rem] md:h-[2rem] lg:h-[2.5rem]"
              src={leftquote}
              alt=""
            />
            <img
          ...
          <div className="text-center my-4">
            <motion.p
              className="text-[1rem] pb-10 max1008:text-sm max670:text-xs"
