...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="flex flex-row flex-wrap hello text-xl md:text-xl lg:text-5xl min1150:text-9xl text-white font-bold max-w-screen-md:max-[450px] mb-1 max375:text-[1.2rem] responsive-title">
