        ...
        <div className="w-[30%] flex flex-col justify-evenly items-end pl-5">
          <div
            ...
            className={`w-80 max1008:w-64 shadow-[5px_5px_20px_0px_rgba(0,_0,_0,_0.25)] overflow-hidden flex flex-col items-start rounded-[23px] -mr-[5rem] z-20 ${
              isHovered ? `bg-[#30AFBC] text-white` : `bg-white`
            } `}
            onMouseEnter={handleHover}
            onMouseLeave={handleUnhover}
          >
            {isHovered?(
            <div className="flex flex-col justify-end pt-6 gap-3 items-start rounded">
              ...
              <div className="self-stretch relative flex flex-col ml-6 pb-8 items-start">
                ...
                <a href="/User_interface">
                    <button className="border-[.1rem] border-white rounded mt-2 px-2 py-1 hover:bg-white hover:text-black">View more</button>
                  </a>
              </div>
            </div>
            ):(
            ...
            <div className="bg-white flex flex-col justify-end pt-6 gap-3 items-start rounded">
              ...
              <div className="self-stretch relative flex flex-col ml-6 pb-8 items-start">
                <div className="text-sm font-['Inter'] leading-[23px] relative w-full max1008:text-xs">
                  ...
                  data-driven insights for effective business growth and
            ...
            <div className="bg-white flex flex-col justify-end pt-6 gap-3 items-start rounded">
              ...
              <div className="self-stretch relative flex flex-col ml-6 pb-8 items-start">
                <div className="text-sm font-['Inter'] leading-[23px] relative w-full max1008:text-xs">
                  ...
                  transactions with our trusted payment solutions, ensuring data
                  security and peace of mind with seamless transactions
                </div>
              </div>
            </div>
          </div>
