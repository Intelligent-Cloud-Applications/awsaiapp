...
function Instructors({ instructors, setInstructors }) {
  ...
  return (
    <div className="mx-auto" style={{ overflowY: 'auto', maxHeight: '76vh' }}>
      <h1 className="font-medium text-7xl text-center">INSTRUCTORS SECTION</h1>
          ...
          {instructors.map((instructor, index) => (
            <div key={index} className="mt-2">
              ...
              <div className="relative flex items-center">
                ...
                >
                  <span
                    className={`block text-[#000000] font-inter text-[22px] ${instructor.uploadedFile ? 'hidden' : 'block'
                      }`}
                  >
                    Choose File
                  </span>
                  ...
                  <div
                    className={`absolute top-0 left-0 right-0 bottom-0 flex items-center justify-between px-2 truncate ${instructor.uploadedFile ? 'block' : 'hidden'
                      }`}
                  >
              ...
              <div className="relative mt-2">
                ...
                {/* Name line container */}
                <div
                  className={`absolute left-0 right-0 bottom-0 h-[0.5px] ${activeInstructorIndex === index ? 'bg-black' : 'bg-[#939393]'
                    }`}
                ></div>
              ...
              <div className="relative">
                ...
                {/* Name line container */}
                <div
                  className={`absolute left-0 right-0  h-[0.5px] ${activeInstructorIndex === index ? 'bg-black' : 'bg-[#939393]'
                    }`}
                ></div>
