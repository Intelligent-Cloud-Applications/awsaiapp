...
const LeftBanner = ({ displayAfterClick }) => {
  ...
  return (
      <div className="min-w-[4rem] p-3 bg-[#c4c4c4e1] rounded-[17px] overflow-auto max1050:w-screen max1050:fixed max1050:bottom-[0] max1050:left-0 max1050:items-center max1050:z-30">
