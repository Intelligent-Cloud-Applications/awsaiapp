...
const MonthlyReport = ({ institution: tempInstitution }) => {
  ...
  const selectedClient = Array.isArray(item)
    ? item.find((client) => client.institution === institution)
    : null
  const institutionData = Array.isArray(clients.data)
    ? clients.data.find((client) => client.institution === institution)
    : null
  const memberCountByMonth = institutionData
    ? institutionData.memberCountByMonth
    : null
  ...
  const fetchRevenueOfClients = async (selectedYear, selectedMonth) => {
    try {
      ...
      if (
        ...
        RevenueApi.Revenue &&
        selectedYear &&
        selectedYear !== 'Last3YearsData' &&
        selectedYear !== 'Last2YearsData'
      ) {
  ...
  if (selectedClient) {
    ...
    console.log(
      `Country information not available for institution: ${institution}`,
    )
  }
  ...
  return (
    <>
      ...
      <div className="flex w-[100vw] justify-center mt-[-2.5rem]">
        <div
          class="w-[90vw] h-14 relative rounded-2xl"
          style={{
            boxShadow: '0 0 15px rgba(0, 0, 0, 0.2)',
          }}
        >
          <div class="flex h-14 justify-center items-center text-stone-900 text-4xl font-bold font-['Inter'] leading-9 max800:text-[white]">
            {selectedYear} REPORT
          </div>
          <div class="flex justify-end mt-[-2.7rem] mr-[4rem] ">
            ...
            >
              <option
                disabled
                value=""
                className="text-[#000000] text-left text-bold K2D text-[1.2rem]"
              >
                Select a year
              </option>
              {years.map((year) => (
                <option
                  className="text-left text-[#000000] text-bold K2D text-[1.1rem]"
                  key={year}
                  value={year}
                >
                  {year}
      ...
      <div
        className={`flex flex-col justify-center items-center max536:pt-0 gap-1 ${IsDashboard ? 'flex flex-col justify-center items-center max536:pt-0 gap-1 mt-[5rem]' : ''}`}
      >
        {/* first two graph */}
          ...
          <div className="flex mb-4 flex-row justify-between max1300:flex-col max1300:items-center max1300:gap-[1rem] max850:justify-center max850:items-center">
            <div className="relative">
              <div className="flex justify-between">
                ...
                <div>
                  <img
                    className="w-[1.7rem] mb-[-2rem] mt-[0.3rem] mr-[1rem] cursor-pointer opacity-[80%]"
                    onClick={() => handleInfoClick(1)}
                    src={InfoPng}
                    alt=""
                  />
                  {infoContent ===
                    'This graph represents the total number of members for each month' && (
                    <p className="absolute K2D font-[600] p-2 right-[2rem] bg-white top-[3.5rem] rounded-[16px] max600:left-[1rem] max600:top-[4rem]">
                      {infoContent}
                    </p>
                  )}
                </div>
              ...
              <div
                className="flex items-center border-1 px-2 rounded-[20px] border-[#545454] w-[35rem] h-[20rem] mt-[2rem] max600:w-[95vw] max600:h-[60vw] ml-6 max1300:ml-0 max600:mb-8 "
                style={{
            ...
            <div className="relative">
              <div className="flex justify-between">
                ...
                <div>
                  ...
                  />
                  {infoContent ===
                    'This graph shows the total number of Leads each month' && (
                    <p className="absolute K2D font-[600] p-2 right-[4.5rem] bg-white top-[3.5rem] rounded-[16px] max600:left-[2rem] max600:top-[4rem]">
                      {infoContent}
                    </p>
                  )}
                </div>
              ...
              <div
                className="flex items-center border-1 px-2 rounded-[20px] border-[#545454] w-[35rem] h-[20rem] max600:w-[95vw] max600:h-[60vw] mt-[2rem] ml-8 max1300:ml-0 "
                style={{
                  background: 'white',
        ...
        {showDetails && (
          ...
          >
            <h2 className="text-center Inter text-[1.3rem] font-[600] mb-2">
              Details
            </h2>
            <select
              value={selectedMonth}
            ...
            <div>
              <div class="w-[345px] h-[725px] relative bg-white rounded-[18px]">
                <div class="w-[92px] h-[17px] left-[17px] top-[421px] absolute text-black text-base font-semibold font-['Inter'] tracking-wide">
                  Incomes :
                </div>
                <div class="w-[163px] h-[13px] left-[155px] top-[350px] absolute text-black text-xs font-semibold font-['Inter'] tracking-tight">
                  Clients Payment: {renderValue(clientsPayment)}
                </div>
                <div class="w-[163px] h-[13px] left-[155px] top-[420px] absolute text-black text-xs font-semibold font-['Inter'] tracking-tight">
                  Product: {Product}
                </div>
                <div class="w-[163px] h-[13px] left-[155px] top-[490px] absolute text-black text-xs font-semibold font-['Inter'] tracking-tight">
                  Protein: {Protein}
                </div>
                ...
                <div class="w-[140px] h-[17px] left-[7px] top-[624px] absolute text-black text-base font-semibold font-['Inter'] tracking-wide">
                  Total Income :
                </div>
                <div class="w-[184px] h-8 left-[128px] top-[617px] absolute bg-white border border-black"></div>
                <div class="w-[126px] left-[147px] top-[625px] absolute text-black text-base font-[600] font-['Inter'] tracking-wide">
                  {renderValue(totalIncome)}
                </div>
                <div class="w-[140px] h-[17px] left-[17px] top-[571px] absolute text-black text-base font-semibold font-['Inter'] tracking-wide">
                  Profit :
                </div>
                <div class="w-[184px] h-8 left-[128px] top-[563px] absolute bg-white border border-black"></div>
                <div class="w-[118px] left-[147px] top-[571px] absolute text-black text-base font-[600] font-['Inter'] tracking-wide">
                  {renderValue(profit)}
                </div>
                <div class="w-[118px] h-[17px] left-[7px] top-[113px] absolute text-black text-base font-semibold font-['Inter'] tracking-wide">
                  Investments :
                </div>
                <div class="w-[167px] h-[13px] left-[172px] top-[44px] absolute text-black text-xs font-semibold font-['Inter'] tracking-tight">
                  Ads Running: {adsRunning}
                </div>
                <div class="w-[163px] h-[13px] left-[172px] top-[114px] absolute text-black text-xs font-semibold font-['Inter'] tracking-tight">
                  Instructor Payment: {renderValue(instructorPayment)}
                </div>
                <div class="w-[163px] h-[13px] left-[172px] top-[184px] absolute text-black text-xs font-semibold font-['Inter'] tracking-tight">
                  XYZ: 1000
                </div>
                ...
                <div class="w-[140px] h-[17px] left-[8px] top-[248px] absolute text-black text-base font-semibold font-['Inter'] tracking-wide">
                  Total Invest :
                </div>
                <div class="w-[184px] h-8 left-[128px] top-[242px] absolute bg-white border border-black"></div>
                <div class="w-[110px] left-[147px] top-[250px] absolute text-black text-base font-[600] font-['Inter'] tracking-wide">
                  {renderValue(totalInvestement)}
                </div>
              </div>
            </div>
            <div>
              <button
                className="absolute right-0 bottom-0 border rounded-b-lg bg-[#13838d] text-white p-3 w-[22rem]"
        ...
        {/* last two graph */}
        <div
          className={`w-[83vw] max536:bg-transparent max600:mr-[2rem] rounded-3xl p-3  mt-[-2rem]`}
        >
            ...
            <div className="relative">
              <div className="flex justify-between">
                ...
                <div>
                  ...
                  />
                  {infoContent ===
                    'This graph shows the total revenue generated per month' && (
                    <p className="absolute K2D font-[600] p-2 right-[4.5rem] bg-white top-[3.5rem] rounded-[16px] max600:left-[3rem] max600:top-[4rem] max600:right-[1rem]">
                      {infoContent}
                    </p>
                  )}
                </div>
              ...
              <div
                className="flex items-center border-1 px-2 rounded-[20px] border-[#545454] w-[35rem] h-[20rem] max600:w-[95vw] max600:h-[60vw] mt-[2rem] ml-8 max600:mb-8"
                style={{
                  background: 'linear-gradient(180deg, #30AFBC 0%, #000 100%)',
                }}
              >
              ...
              <p
                className="text-end Inter text-[1.15rem] font-[600] text-[#1A8C9B] mr-3 mt-2 cursor-pointer"
                ref={detailsRef}
                onClick={handleClick}
              >
                Details
            ...
            <div className="relative">
              <div className="flex justify-between">
                ...
                <div>
                  ...
                  />
                  {infoContent ===
                    'This graph shows the total attendance increase each month' && (
                    <p className="absolute K2D font-[600] p-2 right-[4.5rem] bg-white top-[3.5rem] rounded-[16px] max600:left-[3rem] max600:top-[7rem] max600:right-[1rem]">
                      {infoContent}
                    </p>
                  )}
                </div>
              ...
              <div
                className="flex items-center border-1 px-2 rounded-[20px] border-[#545454] w-[35rem] h-[20rem] max600:w-[95vw] max600:h-[60vw] mt-[2rem] ml-8 "
                style={{
                  background: 'white',
                  boxShadow: '0 4px 40px rgba(0, 0, 0, 0.3)',
                }}
