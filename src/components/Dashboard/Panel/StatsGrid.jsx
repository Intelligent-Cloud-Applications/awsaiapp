                ...
                return (
                    <div
                        ...
                        onClick={() => {
                            ...
                            onStatClick(config.sortConfig, index);
                        }}
                        className={`bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-200 p-4 cursor-pointer ${activeIndex === index ? 'ring-1 ring-cyan-500 shadow-md' : ''
                            }`}
                    >
