...
import { Badge, Button, Dropdown, Modal, Pagination, Select, Table, TextInput } from "flowbite-react";
            ...
            {screenWidth > 1023 ? (
              <>
                ...
                >
                  <ToastContainer />
                  <div
                    className={`w-[78%] mt-4 rounded-[0] flex flex-col md:flex-row justify-end space-y-4 items-center bg-white py-3 pr-4 shadow-lg lg:space-x-4 lg:space-y-0 upper-section ${
                      isResponsive ? "flex-col" : "flex-row"
                    }`}
                  >
                    <div className="flex flex-col md:flex-row sm:w-auto space-y-4 sm:space-x-4 justify-center items-center md:items-end">
                      <Select
                        ...
                        className={`text-white font-semibold shadow-md border-1 focus:outline-none focus:ring-2 focus:ring-blue-400 w-full ${
                          isResponsive ? "mt-2" : "sm:w-auto"
                        }`}
                      >
                        {instituteType === "" && (
                      ...
                      <Link
                        ...
                        onClick={(e) => {
                          if (instituteType === "") {
                            ...
                            toast.error(
                              "Please Select a type of Institution.",
                              {
                                position: "top-right",
                                autoClose: 5000,
                      ...
                      >
                        <button
                          className={`flex items-center gap-2 p-2 bg-[#48d6e0] font-semibold text-sm rounded-md hover:bg-[#3ae1f7] focus:outline-none focus:ring-2 focus:ring-[#6cebff] transition duration-300 ease-in-out transform hover:scale-105 shadow-md w-full ${
                            isResponsive ? "mt-2" : "sm:w-auto"
                          }`}
                        >
                  ...
                  <div className="w-[78%] mt-4 rounded-md flex flex-col justify-center bg-white py-3 flowbite-table">
                    ...
                    {/* Headings */}
                    <div
                      className={`overflow-x-auto w-full mb-4 max-h-[600px] md:max-h-[600px] overflow-y-auto ${
                        isResponsive ? "px-2" : ""
                      }`}
                    >
                    ...
                    <div className="py-2 flex justify-between items-center px-4">
                      <div className="text-sm text-gray-600">
                        ...
                        <strong>
                          {startIndex + 1}-
                          {startIndex + clientsToDisplay.length}
                        </strong>{" "}
                              ...
                              >
                                ...
                                <Modal.Body>
                                  <div className="flex flex-col items-center space-y-4">
                                    ...
                                    <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400 text-center">
                                      This is the attendance QR for the{" "}
                                      {client.companyName} institution. Please
                                      tap on the QR code to download it.
                                    </p>
                                  </div>
                                </Modal.Body>
                                <Modal.Footer>
