...
const Terms1 = () => {
    return (
        <>
            <div className="flex flex-col items-center w-[78%] ml-[7.56%] pb-[5rem] bg-white">
                <div className=" text-justify flex flex-col items-center  w-100 h-100 mt-[2rem] p-0 overflow-x-hidden w-[85%] max-w-[80rem]">
                    <h1 className=" nor text-[26px] text-center font-bebas-neue pt-3">Cancellation/Refund Policy</h1>
                    ...
                    <h4 className="text-[1.2rem] max450:text-[1rem] text-left mt-5 font-bold w-full sm:ml-0 ml-5 ">Subscription Fees</h4>
                    <p className="mt-2 sm:ml-0 ml-5 mr-5">
                    ...
                    <h4 className="text-[1.2rem] max450:text-[1rem] text-left mt-5 font-bold w-full sm:ml-0 ml-5 ">Cancellation</h4>
                    <p className="mt-2 sm:ml-0 ml-5 mr-5">
                    ...
                    <h4 className="text-[1.2rem] max450:text-[1rem] text-left mt-5 font-bold w-full sm:ml-0 ml-5 ">Refunds</h4>
                    <p className="mt-2 sm:ml-0 ml-5 mr-5">
                    ...
                    <h4 className="text-[1.2rem] max450:text-[1rem] text-left mt-5 font-bold w-full sm:ml-0 ml-5  ">Periodic Discount Offers</h4>
                    <p className="mt-2 sm:ml-0 ml-5 mr-5">
                    ...
                    <h4 className="text-[1.2rem] max450:text-[1rem] text-left mt-5 font-bold w-full sm:ml-0 ml-5 ">Contact Us</h4>
                    <p className="mt-2 sm:ml-0 ml-5 mr-5">
