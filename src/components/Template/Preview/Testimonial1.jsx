...
const Testimonial1 = () => {
  ...
  // {/*                Profile pics state                 */ }
  const [testimonials, setTestimonials] = useState([testi1, testi2])
    ...
    <div className="sans-sarif ml-[7.56%] max500:h-[20rem] max700:h-[40rem] size w-[78%] new">
      <div className="Test-size bg-black flex flex-col item-center">
        ...
        <div className=" m-0 p-0">
          ...
          <h1
            className="mona h-[4.5rem] w-[100%] font-[400] "
          ...
          <div className="flex relative z-2 object-cover  justify-center max1050:pl-8 max1050:pr-8">
            <h2
              className="text-[1rem] z-2 pt-4  text-white w-[40rem] max478:text-[0.75rem] text-center font-sans"
