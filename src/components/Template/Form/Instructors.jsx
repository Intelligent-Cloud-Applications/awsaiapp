  ...
  const removeInstructor = async (indexToRemove) => {
    ...
    if (instructor.instructorId) {
      ...
      try {
        await API.del(
          'clients',
          `/user/development-form/delete-instructor/${instructor.institution}`,
          {
            body: {
  ...
  return (
    ...
    >
      ...
      <h5 className="w-[28rem] max950:w-[15rem] text-[#cc3f3f] text-[13px]">
        ** The Instructor page shown is just an example how your given data will
        look like for the Instructors page it will not change on giving your
        input.**
      </h5>
      <h5 className="w-[28rem] max950:w-[17rem] text-[#939393]">
        Introduce expert team members, emphasizing expertise and value they
            ...
            <div key={index} className="mt-2">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={(e) =>
                    handleInstructorChange(index, 'emailId', e.target.value)
                  }
                  placeholder="emailId"
                  className="w-full max-w-[28rem] text-black border-none outline-none bg-transparent"
                  onFocus={() => toggleActiveInstructor(index)}
              ...
              <div className="relative">
                <input
                  ...
                  onChange={(e) =>
                    handleInstructorChange(index, 'position', e.target.value)
                  }
