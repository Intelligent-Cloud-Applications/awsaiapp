  ...
  return (
    ...
    >
      ...
      <h5 className="w-[28rem] max950:w-[15rem] text-[#cc3f3f] text-[13px]">
        ** The Privacy page shown is just an example how your given data will
        look like for the Privacy page it will not change on giving your
        input.**
      </h5>
      <h5 className="w-[28rem] max950:w-[17rem] text-[#939393]">
        Establish transparent guidelines, sharing policies and terms for clarity
        and understanding.
      </h5>
      <div className="mt-8">
          ...
          <div key={index} className="mt-4">
            ...
            {type === 'Refund Policy' || type === 'Terms and Conditions' ? (
              value.map((item, itemIndex) => (
                <div key={itemIndex} className="mt-4">
                  ...
                  <input
                    ...
                    placeholder={
                      type === 'Refund Policy' ? 'Refund Heading' : 'Title'
                    }
                  ...
                  <textarea
                    ...
                    placeholder={
                      type === 'Refund Policy' ? 'Refund Content' : 'Content'
                    }
                    className="w-full max-w-[28rem] text-black border-none outline-none bg-transparent mt-2 resize-none placeholder-border-b-2 policy-textarea"
                    rows={3}
                  />
              ...
              <textarea
                value={value}
                onChange={(e) =>
                  handlePolicyChange(type, 'content', e.target.value)
                }
