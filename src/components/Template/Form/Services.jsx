  ...
  return (
    ...
    >
      ...
      <h5 className="w-[28rem] max950:w-[17rem] text-[#939393]">
        Highlight services distinctly, showcasing their benefits and unique
        value propositions for your audience's needs.
      </h5>
      <div className="mt-4">
        <div className="relative">
          ...
          >
            {isHeading ? (
              ...
              <span>
                {src_Components_Home_Why__h1 ||
                  'Heading (Why choose HappyPrancer?)'}
              </span>
            )}
          </h5>
          <div
        ...
        <div className="relative">
          ...
          >
            {issmallHeading ? (
              ...
              <span>
                {src_Components_Home_Header3__h1 ||
                  'Sub Heading (A Fitness Movement)'}
              </span>
            )}
          </h5>
          <div
              ...
              <div className="relative">
                ...
                <div
                  className={`absolute left-0 right-0 bottom-0 h-[0.5px] ${
                    activeDanceTypeIndex === index ? 'bg-black' : 'bg-[#939393]'
                  }`}
                ></div>
              </div>
            </div>
