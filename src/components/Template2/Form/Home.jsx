...
function Home({ TagLine, setTagLine, video, setVideo, selectedMedia, setSelectedMedia, mediaType, TagLine1, setTagLine1, setMediaType, TagLine2, setTagLine2, TagLine3, setTagLine3 }) {
  ...
  return (
    <div className="home h-[185vh] [@media(max-width:1024px)]:h-screen [@media(max-width:1024px)]:mb-[12rem]">
      ...
      <div className="flex justify-center [@media(max-width:1024px)]:ml-0">
        <div className="w-[60%] p-8 [@media(max-width:1024px)]:p-0 [@media(max-width:1024px)]:w-full">
          <div className="relative mt-2">
            <h5
              className="text-[#939393] relative cursor-pointer py-2 [@media(max-width:1024px)]:w-full"
            >
              <TextInput
                id="inputField"
                value={TagLine}
