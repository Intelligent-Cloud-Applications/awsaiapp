          ...
          {Ctx.products.map((product) => {
            return (
              <Box
                ...
                className="box flex flex-col bg-white xl:w-[25rem] rounded-lg shadow-lg justify-between"
              >
                <div>
                ...
                <a
                  href={`https://happyprancer.com/pay/awsaiapp/${product.productId}/${UserCtx.cognitoId}`}
                  className="text-white text-lg xl:text-xl font-semibold bg-black hover:bg-[#30AFBC] hover:text-black py-2 px-4 rounded-lg flex justify-center items-center"
                >
                  Get Started
                </a>
              </Box>
