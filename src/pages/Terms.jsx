    ...
    <div>
      ...
      <div className="bg-white text-black min-h-screen">
        ...
        <p className="mt-24 px-8 md:px-80 ">
          Welcome to Intelligent Cloud Application! Before you access our
          services, please read these Terms and Conditions carefully. By using
        ...
        <div className="px-10 md:px-80 py-5">
          ...
          <ul className="list-disc ml-6">
            ...
            <li>
              b. Impersonating any person or entity or misrepresenting your
              affiliation with a person or entity.
            </li>
            <li>c. Uploading or transmitting any malicious code or viruses.</li>
            <li>
              d. Attempting to gain unauthorized access to our systems or other
              users' accounts.
            </li>
            <li>
              e. Engaging in any activity that disrupts the normal operation of
              our services.
            </li>
          </ul>
        </div>
        ...
        <div className="px-10 md:px-80 py-3">
          ...
          <p>
            ...
            responsible for keeping your payment information up-to-date, and any
            unpaid fees may result in suspension or termination of your
            services.
          </p>
        </div>
        ...
        <div className="px-10 md:px-80 py-3">
          ...
          <p>
            All content and materials provided by Intelligent Cloud Application,
            including but not limited to software, designs, logos, and text, are
            the property of Intelligent Cloud Application and are protected by
        ...
        <div className="px-10 md:px-80 py-3">
          ...
          <p>
            ...
            suspend your access to our services at our sole discretion, without
            notice, for any reason, including if you breach these Terms and
            Conditions.
          </p>
        </div>
        ...
        <div className="px-10 md:px-80 py-3">
          ...
          <p>
            ...
            special, consequential, or incidental damages resulting from the use
            or inability to use our services. In no event shall our liability
        ...
        <div className="px-10 md:px-80 py-3 mb-20">
          ...
          <p>
            ...
            Conditions, please contact us at admin@awsaiapp.com.
          </p>
        </div>
      </div>
      <Footer />
