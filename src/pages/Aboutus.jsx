        ...
        <div className="overflow-hidden bg-black flex flex-col mb-5 pt-1 gap-8  ">
          <div className="flex flex-col sm:ml-0">
            <div className="w-full flex flex-col md:flex-row md:justify-between max800:justify-center items-center">
              ...
              <div
                className="pl-[4rem] max800:pt-[7rem] max800:pl-[2rem] max800:w-[80%] text-[48px] md:text-[84px] font-family-[Rubik_Mono_One] text-[#30afbc] font-bold max800:text-[3rem]"
              >
            ...
            <div className="Container1 md:pb-[12rem] max800:pb-[23rem] max767:mb-[2rem] max450:pb-[1rem]  md:px-2">
              <div className=" wrapper flex flex-col md:flex-row justify-between items-start p-[1rem] gap-2">
                <img
                  src={about3}
                  alt="About 3"
                  className="about3 w-[100%] md:w-[28.5rem] h-[14rem] rounded-[10px] max800:mt-[10rem] max800:ml-[3rem]"
                />
                <img
                  src={about2}
                  alt="About 2"
                  className="about2 w-[100%] md:w-[28.5rem] h-[14rem] rounded-[10px] max800:mt-[10rem]  max800:ml-[3rem]"
                />
                <img
                  src={about4}
                  alt="About 1"
