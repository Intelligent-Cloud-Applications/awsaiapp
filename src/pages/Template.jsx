  ...
  const handleTestimonialsUpload = async () => {
    ...
    try {
      const response1 = await Storage.put(
        `institution-utils/${institutionId}/images/Testimonial/${testimonials[0].uploadedFile}`,
      ...
      const response2 = await Storage.put(
        `institution-utils/${institutionId}/images/Testimonial/${testimonials[1].uploadedFile}`,
      ...
      const response3 = await Storage.put(
        `institution-utils/${institutionId}/images/Testimonial/${testimonials[2].uploadedFile}`,
    ...
    try {
      ...
      for (let i = 0; i < instructors.length; i++) {
        ...
        if (instructor.actualFile) {
          const response = await Storage.put(
            `institution-utils/${institutionId}/images/Instructor/${instructor.uploadedFile}`,
