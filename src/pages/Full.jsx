...
const Full = () => {
  ...
  const handleCountryChange = (e, index) => {
    ...
    const countryCode =
      e.target.options[e.target.selectedIndex].getAttribute('data-countryCode')
    setSubscriptionDetails((prevDetails) => {
  ...
  return (
                  ...
                  <div className="col gap-4">
                    ...
                    {templateDetails.ClassTypes &&
                      templateDetails.ClassTypes.length > 0 && (
                        <>
                          {templateDetails.ClassTypes.map(
                            (ClassType, index) => (
                              <div key={index}>
                                <div className="rectangular-box">
                                  <input
                    ...
                    >
                      <button
                        ...
                        className="bg-[#ffffff]  text-[#30AFBC] font-bold py-2 px-4 rounded-lg shadow-lg"
                    ...
                    <div className="rectangular-box">
                      ...
                      <button
                        onClick={() =>
                          downloadImage(templateDetails.Testimonial[0].img)
                        }
                    ...
                    <div className="rectangular-box">
                      ...
                      <button
                        onClick={() =>
                          downloadImage(templateDetails.Testimonial[1].img)
                        }
                        className="absolute top-0 right-0 mt-[15px] mr-2 px-4 py-2 rounded bg-[#30AFBC] text-white"
                      >
                        View
                    ...
                    <div className="rectangular-box">
                      ...
                      <button
                        onClick={() =>
                          downloadImage(templateDetails.Testimonial[2].img)
                        }
                        className="absolute top-0 right-0 mt-[15px] mr-2 px-4 py-2 rounded bg-[#30AFBC] text-white"
                      >
                        View
                      ...
                      <div key={index}>
                        ...
                        <div className="rectangular-box">
                          <input
                            value={item.heading}
                            onChange={(event) =>
                              handleRefundChange(event, index, 'heading')
                            }
                            className="w-full text-black border-none outline-none bg-transparent"
                        ...
                        <div className="rectangular-box">
                          <textarea
                            value={item.content}
                            onChange={(event) =>
                              handleRefundChange(event, index, 'content')
                            }
                            className="w-full text-black border-none outline-none bg-transparent"
                        ...
                        <div key={index}>
                          ...
                          <div className="rectangular-box">
                            <input
                              value={item.title}
                              onChange={(event) =>
                                handleTermsDataChange(event, index, 'title')
                              }
                              className="w-full text-black border-none outline-none bg-transparent"
                          ...
                          <div className="rectangular-box">
                            <textarea
                              value={item.content}
                              onChange={(event) =>
                                handleTermsDataChange(event, index, 'content')
                              }
                              className="w-full text-black border-none outline-none bg-transparent"
                        ...
                        <div>
                          <div className="rectangular-box">
                            <input
                              ...
                              onChange={(e) =>
                                handleInstructorChange(e, 'name', index)
                              }
                              className="w-full text-black border-none outline-none bg-transparent"
    ...
    <p>Subscription Type: {subscription.subscriptionType}</p> */}
                        ...
                        <div className="flex flex-row max850:flex-col">
                          <h2 className="text-lg font-bold mt-2 mr-4">
                            Subscription Type:
                          </h2>
                          <div className="border bg-white border-gray-400 rounded-md p-2">
                            <select
                              ...
                              onChange={(e) =>
                                handleSubscriptionTypeChange(e, index)
                              }
                              className="w-full text-black border-none outline-none bg-transparent"
                            >
                        ...
                        {subscription.provides.map((provide, idx) => (
                          <div className="rectangular-box" key={idx}>
                            <input
                              ...
                              value={provide}
                              onChange={(e) =>
                                handleProvideChange(e, index, idx)
                              }
                              placeholder="Provide"
                              className="w-full text-black border-none outline-none bg-transparent"
                            />
