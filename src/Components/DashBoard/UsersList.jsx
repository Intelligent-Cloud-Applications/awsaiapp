...
import UserNamePng from "../../Utils/AWS/UsersList/userName.png";
import DetailsPng from "../../Utils/AWS/UsersList/details.png";
import DuePng from "../../Utils/AWS/UsersList/due.png";
import AttendancePng from "../../Utils/AWS/UsersList/attendance.png";
  ...
  return (
    <div className="w-[100%] flex flex-col items-center pt-6 max536:pt-0 gap-10">
      ...
      >
        ...
        <h2 className="pl-5 text-[1.4rem] max536:mb-3 max536:text-[1.7rem] RussoOne font-thin max536:text-[#404E7C]">
          Members List
        </h2>
