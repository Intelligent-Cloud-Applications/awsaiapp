...
const ProfileUpdate = () => {
  ...
  return (
    <div className="z-10 w-[100%] flex flex-col items-center pt-6  ">
      <div className="w-[75%] max-w-[36rem] z-10 bg-[#ffff]  rounded-3xl p-3 flex flex-col items-center max536:w-[90%]">
        {!isEmailChange ? (
          <>
            {!isChangePassword ? (
              <div className="flex flex-col items-center mb-4">
                ...
                <form className="mt-6 flex flex-col gap-8">
                  ...
                  <div className="flex justify-center">
                    <button
                      className="RussoOne bg-[#404E7C] rounded-lg w-[8rem] text-white py-2 "
              ...
              <>
                <form className="flex flex-col items-center my-4 max536:w-[90%]">
                  ...
                  <button
                    ...
                    className="RussoOne bg-[#404E7C] rounded-lg w-[8rem] text-white py-2 mt-8 "
                  >
                    Change
                  </button>
                </form>
