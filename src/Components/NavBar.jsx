...
const NavBar = () => {
  ...
  />
      ...
      <li className="flex items-center justify-center  hover:text-[#71B48D] ">
        <p
      ...
      <li className="flex items-center justify-center cursor-pointer hover:text-[#71B48D]">
        <p
          className="cursor-pointer"
          onClick={() => {
            Navigate("/aboutus");
          ...
          {isNavActive && (
            <ul className="bg-black shadow-lg w-[10rem] absolute top-[1.6rem] right-0 z-40">
              <li className="flex items-center justify-center h-10   ">
                <p
                  className="cursor-pointer hover:bg-[#71B48D] "
                  onClick={() => {
                    Navigate("/");
                  }}
                >
              ...
              <li className="flex items-center justify-center h-10  hover:bg-[#71B48D]">
                <p
                  className="cursor-pointer"
                  onClick={() => {
                    Navigate("/aboutus");
          ...
          {isNavActive && (
            <div className="bg-[#71B48D] z-40  h-screen w-screen text-white RussoOne text-[1.8rem]">
              <ul className="pt-24 flex flex-col items-start px-24 gap-8">
                <li className="flex items-center justify-center cursor-pointer text-white">
                  <p
                    className="cursor-pointer"
                    onClick={() => {
                      Navigate("/");
